...
<div id="content">
	<div>
		<span style="color: black; text-shadow: rgba(255, 255, 255, 0.3) 0px 0px 4px; display: inline-block; margin:10px 10px 0 0; padding:5px 10px; text-align:center; width:100% height:700px;
				padding-top:35px; padding-left:7.5px; padding-bottom:10px;">
			<p>
			...
			iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi. Lorem ipsum dolor sit amet, consectetuer adipiscing elit, 
			sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.
			</p>
                        <img src="img/Gold-necklace.jpg" width="800px" height="450px" />
			<p>
